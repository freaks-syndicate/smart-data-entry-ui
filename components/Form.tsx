    ...
    <>
      <Stack spacing={2} direction="column" align="center">
        ...
        <FormControl position="relative">
          ...
          <Input type="test" name="name" value={formData.name} onChange={handleChange} />
        ...
        <FormControl position="relative">
          ...
          <Input type="email" name="email" placeholder="john@gmail.com" value={formData.email} onChange={handleChange} />
          <div className="absolute inset-y-0 right-0 flex items-center pr-4 mt-8 cursor-pointer">{renderSpeechIcon('email')}</div>
        </FormControl>
        ...
        <FormControl>
          ...
          <Input type="number" name="year" placeholder="1900" value={formData.year !== null ? formData.year : ''} onChange={handleChange} />
        </FormControl>
        <FormControl position="relative">
          <FormLabel>Address</FormLabel>
          <Textarea name="address" rows={4} value={formData.address} onChange={handleChange} placeholder="Enter your address here..." />
